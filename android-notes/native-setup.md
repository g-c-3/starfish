...
## 4. Voice recorder with noise-reduction toggle
...
## 6. R8/ProGuard (release hardening)
...
## 7. Signature verification (basic tamper check)
...
## 8. Foreground service (optional, for reliability)
